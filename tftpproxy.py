...
while True:
	...
	if request[POS_OPCODE] == OPCODE_READING:
		...
		if chosenAttack == ATTACK_FILE_NOT_FOUND or chosenAttack == ATTACK_ACCESS_VIOLATION or chosenAttack == ATTACK_ILLEGAL_OP or chosenAttack == ATTACK_CHANGE_DPORT or chosenAttack == ATTACK_FILE_NOT_FOUND_WRQ or chosenAttack == ATTACK_DROP_PACKET or chosenAttack == ATTACK_DROP_ACK or chosenAttack == ATTACK_DROP_ERROR:
