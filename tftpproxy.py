...
while True:
	...
	if request[1] == 1:
		fw_proxy_server.sendto(data_bytes, tftp_server_address)
		print(f"Received RRQ from the Client: Client = {client_address} | Data = {data_bytes}")
		...
		print(f"Received ACK from the Client: Cient = {client_address} | ACK-Data = {ack_packet}")
